...
async def get_page_data(session, page):
    ...
    url = f'https://www.labirint.ru/search/%D0%BF%D1%80%D0%BE%D0%B3%D1%80%D0%B0%D0%BC%D0%BC%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5/?stype=0&display=table&page={page}'
    ...
    async with session.get(url=url, headers=headers) as response:
        ...
        for bi in books_items:
            ...
            try:
                book_new_price = int(book_data[3].find("div", class_="price").find("span").text.strip().replace(" ",""))
            except:    
            ...
            try:
                book_sale = round((book_old_price - book_new_price) * 100)
            except:
...
async def gather_data():
    ...
    url = 'https://www.labirint.ru/search/%D0%BF%D1%80%D0%BE%D0%B3%D1%80%D0%B0%D0%BC%D0%BC%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5/?display=table'
